...
<div class="container">
    ...
    if (isset($_POST['kirim'])) {
        ...
        $email_pengirim = "pachanddfs@gmail.com";
        $isi=$_POST['isi'];
        $isi2=$_POST['isi2'];
        $isi3=$_POST['isi3'];
        $subjek=$_POST['subjek'];
        ...
        $mail->Subject    = $subjek;
        $mail->Body       = $isi."<br>"."Jenis Kelamin : ".$isi2.$isi3; 
...
<br>
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        ...
        <div class="form-group">
      <label><input type="radio" name="isi2" value ="Laki-laki" >Laki-laki</label>
    </div>
      <label><input type="radio" name="isi3" value ="Perempuan">Perempuan</label>
    </div>
